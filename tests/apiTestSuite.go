...
func (suite *apiTestSuite) newAuthPasswordless() (*auth.Auth, error) {
	...
	return auth.NewPasswordlessAuth(auth.ConfigPasswordless{
		...
		FuncUserFindByAuthToken: func(token string) (userID string, err error) { return "111", nil },
...
func (suite *apiTestSuite) newAuthWithRegistrationDisabled() (*auth.Auth, error) {
	...
	return auth.NewUsernameAndPasswordAuth(auth.ConfigUsernameAndPassword{
		...
		FuncTemporaryKeySet:     func(key string, value string, expiresSeconds int) (err error) { return nil },
		FuncUserFindByAuthToken: func(token string) (userID string, err error) { return "111", nil },
		FuncUserFindByUsername:  func(username string, firstName string, lastName string) (userID string, err error) { return "111", nil },
		FuncUserLogin:           func(username string, password string) (userID string, err error) { return "111", nil },
		FuncUserLogout:          func(userID string) (err error) { return nil },
		FuncUserStoreAuthToken:  func(sessionID string, userID string) (err error) { return nil },
